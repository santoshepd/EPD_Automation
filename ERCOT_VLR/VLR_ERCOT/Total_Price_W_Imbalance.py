...
# Calculate the final data value (handle division by zero if needed)
...
insert_query = """
    INSERT INTO ercot_vlr_tot_pricewimbalance 
...
print("Data inserted into `ercot_vlr_tot_pricewimbalance` successfully!")
