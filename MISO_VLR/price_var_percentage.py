# Price_Var_Percentage.py - autogenerated file
import os
...
query = """
    ...
    FROM miso_vlr_price_variance pv
    JOIN miso_vlr_da_lmps da 
    ON pv.hierarchy_id = da.hierarchy_id 
    AND pv.date = da.date 
    AND pv.he = da.he
    WHERE pv.hierarchy_id BETWEEN 1 AND 19
"""
...
# Step 5: Insert into miso_vlr_price_variance_percentage
try:
    conn = psycopg2.connect(**DB_PARAMS)
    cursor = conn.cursor()

    insert_query = """
        INSERT INTO miso_vlr_price_variance_percentage 
    ...
    cursor.close()
    conn.close()
    print("✅ Price variance percentage inserted into `miso_vlr_price_variance_percentage` successfully!")
