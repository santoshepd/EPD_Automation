...
# Step 5: Insert into miso_vlr_load_variance_percentage
try:
    conn = psycopg2.connect(**DB_PARAMS)
    cursor = conn.cursor()

    insert_query = """
        INSERT INTO miso_vlr_load_variance_percentage 
    ...
    cursor.close()
    conn.close()
    print("✅ Load variance percentage inserted into `miso_vlr_load_variance_percentage` successfully!")
