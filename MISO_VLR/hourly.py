...
query = """
    ...
    FROM miso_vlr_utilized_cost uc
...
# Step 6: Insert into miso_vlr_hourly_cost
try:
    conn = psycopg2.connect(**DB_PARAMS)
    cursor = conn.cursor()

    insert_query = """
        INSERT INTO miso_vlr_hourly_cost 
    ...
    print("✅ Data inserted into `miso_vlr_hourly_cost` successfully!")

except Exception as e:
    print(f"❌ Error inserting into `miso_vlr_hourly_cost`: {e}")
