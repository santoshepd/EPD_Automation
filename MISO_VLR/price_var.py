# Price_Variance.py - autogenerated file
...
query = """
    ...
    FROM miso_vlr_rt_lmps rt
    JOIN miso_vlr_da_lmps da 
    ON rt.hierarchy_id = da.hierarchy_id 
    AND rt.date = da.date 
    AND rt.he = da.he
    WHERE rt.hierarchy_id BETWEEN 1 AND 19
"""
...
try:
    ...
    insert_query = """
        INSERT INTO miso_vlr_price_variance 
    ...
    cursor.close()
    conn.close()
    print("✅ Data inserted into `miso_vlr_price_variance` successfully!")

except Exception as e:
    print(f"❌ Error inserting data into `miso_vlr_price_variance`: {e}")
