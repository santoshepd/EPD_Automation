# Total_Hedge_Cost_W_Imbalance.py - autogenerated file
import os
...
query = """
    ...
    FROM miso_vlr_tot_hedgecostwoimbalance hcwi
    JOIN miso_vlr_tot_costofimbalance ci
    ON hcwi.hierarchy_id = ci.hierarchy_id 
    AND hcwi.date = ci.date 
    AND hcwi.he = ci.he
    WHERE hcwi.hierarchy_id BETWEEN 1 AND 19
"""
...
# Step 6: Insert into miso_vlr_tot_hedgecostwimbalance
try:
    conn = psycopg2.connect(**DB_PARAMS)
    cursor = conn.cursor()

    insert_query = """
        INSERT INTO miso_vlr_tot_hedgecostwimbalance 
    ...
    print("✅ Data inserted into `miso_vlr_tot_hedgecostwimbalance` successfully!")

except Exception as e:
    print(f"❌ Error inserting into `miso_vlr_tot_hedgecostwimbalance`: {e}")
