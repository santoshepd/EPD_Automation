...
# Step 5: Insert into pjm_vlr_load_variance
try:
    conn = psycopg2.connect(**DB_PARAMS)
    cursor = conn.cursor()

    insert_query = """
        INSERT INTO pjm_vlr_load_variance 
    ...
    cursor.close()
    conn.close()
    print("✅ Data inserted into `pjm_vlr_load_variance` successfully!")

except Exception as e:
    print(f"❌ Error inserting data into `pjm_vlr_load_variance`: {e}")