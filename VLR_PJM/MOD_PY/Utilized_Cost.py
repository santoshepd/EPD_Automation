...
query = """
    ...
    FROM pjm_vlr_tot_pricewimbalance tpw
...
# Step 6: Insert into pjm_vlr_utilized_cost
try:
    conn = psycopg2.connect(**DB_PARAMS)
    cursor = conn.cursor()

    insert_query = """
        INSERT INTO pjm_vlr_utilized_cost 
    ...
    print("✅ Data inserted into `pjm_vlr_utilized_cost` successfully!")

except Exception as e:
    print(f"❌ Error inserting into `pjm_vlr_utilized_cost`: {e}")