...
query = """
    ...
    FROM pjm_vlr_price_variance pv
    JOIN pjm_vlr_da_lmps da 
...
# Step 5: Insert into pjm_vlr_price_variance_percentage
try:
    conn = psycopg2.connect(**DB_PARAMS)
    cursor = conn.cursor()

    insert_query = """
        INSERT INTO pjm_vlr_price_variance_percentage 
    ...
    cursor.close()
    conn.close()
    print("✅ Price variance percentage inserted into `pjm_vlr_price_variance_percentage` successfully!")
