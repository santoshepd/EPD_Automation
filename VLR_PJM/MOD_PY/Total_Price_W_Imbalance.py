...
query = """
    ...
    FROM pjm_vlr_tot_hedgecostwimbalance hcw
    JOIN pjm_vlr_rt_load rt_load
...
# # Step 6: Insert into pjm_vlr_tot_pricewimbalance
try:
    conn = psycopg2.connect(**DB_PARAMS)
    cursor = conn.cursor()

    insert_query = """
        INSERT INTO pjm_vlr_tot_pricewimbalance 
    ...
    print("✅ Data inserted into `pjm_vlr_tot_pricewimbalance` successfully!")

except Exception as e:
    print(f"❌ Error inserting into `pjm_vlr_tot_pricewimbalance`: {e}")