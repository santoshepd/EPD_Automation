...
query = """
    ...
    FROM pjm_vlr_tot_hedgecostwoimbalance hcwi
    JOIN pjm_vlr_tot_costofimbalance ci
...
# Step 6: Insert into pjm_vlr_tot_hedgecostwimbalance
try:
    conn = psycopg2.connect(**DB_PARAMS)
    cursor = conn.cursor()

    insert_query = """
        INSERT INTO pjm_vlr_tot_hedgecostwimbalance 
    ...
    print("✅ Data inserted into `pjm_vlr_tot_hedgecostwimbalance` successfully!")

except Exception as e:
    print(f"❌ Error inserting into `pjm_vlr_tot_hedgecostwimbalance`: {e}")