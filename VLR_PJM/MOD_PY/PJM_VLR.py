...
# Step 1: Fetch from pjm_vlr_hourly_cost
query = """
    SELECT hierarchy_id, date, he, data AS hourly_vlr_cost
    FROM pjm_vlr_hourly_cost
...
try:
    ...
    print("✅ Data inserted into `pjm_vlr` successfully!")

except Exception as e:
    print(f"❌ Error inserting into `pjm_vlr`: {e}")
