...
query = """
    ...
    FROM pjm_vlr_da_lmps da_lmps
    JOIN pjm_vlr_da_load da_load 
...
# Step 6: Insert into pjm_vlr_tot_hedgecostwoimbalance
try:
    conn = psycopg2.connect(**DB_PARAMS)
    cursor = conn.cursor()

    insert_query = """
        INSERT INTO pjm_vlr_tot_hedgecostwoimbalance 
    ...
    print("✅ Data inserted into `pjm_vlr_tot_hedgecostwoimbalance` successfully!")

except Exception as e:
    print(f"❌ Error inserting into `pjm_vlr_tot_hedgecostwoimbalance`: {e}")