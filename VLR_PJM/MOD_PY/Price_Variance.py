...
try:
    ...
    insert_query = """
        INSERT INTO pjm_vlr_price_variance 
    ...
    cursor.close()
    conn.close()
    print("✅ Data inserted into `pjm_vlr_price_variance` successfully!")

except Exception as e:
    print(f"❌ Error inserting data into `pjm_vlr_price_variance`: {e}")