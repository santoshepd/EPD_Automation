...
# df["day"] = df["date"].dt.isoweekday() % 7 + 1  # 1 (Sun) to 7 (Sat)
...
try:
    ...
    cursor.close()
    conn.close()
    print("✅ Data inserted into `nyiso_vlr_price_variance` successfully!")

except Exception as e:
    print(f"❌ Error inserting data into `nyiso_vlr_price_variance`: {e}")
