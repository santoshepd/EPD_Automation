...
# ✅ Path to Excel file
file_path = "/home/ubuntu/workspace/hp/repos/db_populate_V2/TLE-Automation/PJM_SHAPING/PJM_DA_LMP_SH.xlsx"

# ✅ Table to insert into
table_name = "da_lmps_pjm_sh"   # 👈 change if you want to insert into nyiso_shaping instead
